...
{	
	...
	public class MainMenu extends AbstractPanel
	{
		...
		override public function init( ):void
		{
			...
			Tweener.addTween( _twitterButton, { delay: baseDelay + Math.random( ) * .5, time: .5, x: Starling.current.stage.stageWidth - _twitterButton.width - margin } );
			...
			Tweener.addTween( _optionsButton, { delay: baseDelay + Math.random( ) * .5, time: .5, y: Starling.current.stage.stageHeight - _optionsButton.height - margin } );
