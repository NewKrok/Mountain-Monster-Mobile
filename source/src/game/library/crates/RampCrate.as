...
package src.game.library.crates
{
	...
	public class RampCrate extends BaseCrate
	{
		private const WIDTH:uint = 75;
		private const HEIGHT:uint = 37;

		public function RampCrate( world:b2World, position:Point, scale:Number )
		{
		...
		{
			this._image = new Image( StaticAssetManager.instance.getTexture( 'crate_4' ) );
		}
	}
}
