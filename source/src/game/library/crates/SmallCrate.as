...
package src.game.library.crates
{
	...
	public class SmallCrate extends BaseCrate
	{
		private const WIDTH:uint = 25;
		private const HEIGHT:uint = 25;

		public function SmallCrate( world:b2World, position:Point, scale:Number )
		{
		...
		{
			this._image = new Image( StaticAssetManager.instance.getTexture( 'crate_0' ) );
		}
	}
}