...
package src.assets
{
	...
	public class TaskListWorld2 implements ITaskList
	{
		private const _tasks:Vector.<AchievementVO> = new <AchievementVO>[
			new AchievementVO( 0, 6, 'Task', 'Do $value/6 Backflip in total in any level' ),
			new AchievementVO( 1, 1, 'Task', 'Earn 3 star in any level.' ),
			new AchievementVO( 2, 1, 'Task', 'Do 2 Frontflip in one level.' ),
			new AchievementVO( 3, 6, 'Task', 'Do $value/6 Nice Air Time in total in any level.' ),
			...
			new AchievementVO( 7, 6, 'Task', 'Do $value/6 Frontflip in total in any level.' ),
			new AchievementVO( 8, 12, 'Task', 'Earn 3 star in $value/12 level.' ),
			new AchievementVO( 9, 15, 'Task', 'Do $value/15 Nice Air Time in total in any level.' ),
			new AchievementVO( 10, 1, 'Task', 'Complete level 1 less than 25 sec.' ),
			new AchievementVO( 11, 1, 'Task', 'Do 9 Nice Air Time in one level.' ),
			...
			new AchievementVO( 16, 1, 'Task', 'Do 3 Backflip in one level.' ),
			...
			new AchievementVO( 19, 1, 'Task', 'Do 2 Backflip, 2 Frontflip, 2 Nice Air Time and 2 Nice Wheelie in any level.' )
		]
