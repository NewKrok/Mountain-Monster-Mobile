...
package src.assets
{
	...
	public class TaskListWorld1 implements ITaskList
	{
		private const _tasks:Vector.<AchievementVO> = new <AchievementVO>[
			new AchievementVO( 0, 3, 'Task', 'Do 3 Backflip in total in any level' ),
			new AchievementVO( 1, 3, 'Task', 'Do 3 Frontflip in total in any level.' ),
			new AchievementVO( 2, 50, 'Task', 'Pick up 50 coins in total.' ),
			...
			new AchievementVO( 6, 100, 'Task', 'Pick up 100 coins in total.' ),
			new AchievementVO( 7, 3, 'Task', 'Do 3 Nice Air Time in total in any level.' ),
			new AchievementVO( 8, 12, 'Task', 'Earn 3 star in 12 level.' ),
			new AchievementVO( 9, 3, 'Task', 'Do 3 Wheelie in total in any level.' ),
			...
			new AchievementVO( 13, 12, 'Task', 'Do 12 Nice Air Time in total in any level.' ),
			new AchievementVO( 14, 1, 'Task', 'Complete level 12 less than 25 sec.' ),
			new AchievementVO( 15, 20, 'Task', 'Do 20 Backflip in total in any level.' ),
			new AchievementVO( 16, 1, 'Task', 'Do 5 Wheelie in one level.' ),
			new AchievementVO( 17, 12, 'Task', 'Earn 3 star in 12 level.' ),
			new AchievementVO( 18, 1, 'Task', 'Do 1 Backflip, 1 Frontflip, 1 Nice Air Time and 1 Wheelie in one level.' ),
